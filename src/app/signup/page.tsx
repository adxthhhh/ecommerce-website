    ...
    <div className="min-h-[80dvh] flex items-center justify-center p-6">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-sm text-[#6b6b6b]">Join the MONOSTORE experience.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="name" className="text-xs font-bold uppercase tracking-wider text-[#9a9a9a]">
              Full Name
            </label>
            <input
              id="name"
        ...
        <div className="mt-8 pt-6 border-t border-[#e5e5e5] text-center">
          <p className="text-sm text-[#6b6b6b]">
            ...
            <Link href="/login" className="text-black font-bold hover:underline transition-base">
              Sign in
            </Link>
          </p>
        </div>
